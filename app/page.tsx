      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative h-[100%] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0 bg-[#063d21]/60" />
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 py-20 md:py-24 lg:py-32">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div
                className="inline-flex flex-col items-center gap sm:gap-3 px-4 sm:px-5 py-2 sm:py-2.5 rounded-md 
          ...
          animate-fade-in-down hover:bg-white/15 transition-all duration-300"
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-white mb-4 sm:mb-6 animate-fade-in-up">
                <span
                  className="block font-serif italic text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 
        ...
        <section className="py-10 bg-gradient-to-r from-gray-50 to-gray-50 overflow-hidden">
          <div className="container mx-auto px-6 mb-8">
            <div className="text-center">
              <span className="text-sm font-medium text-primary tracking-wider uppercase animate-pulse">
            ...
            <div className="animate-marquee flex items-center gap-10 py-4">
              {[...companyLogos, ...companyLogos, ...companyLogos].map(
                (company, index) => (
                  ...
                  >
                    <div
                      className="w-24 h-24 rounded-full bg-white shadow-sm border border-primary flex items-center justify-center p-4 
          ...
          <div className="container mx-auto px-6 mt-8 text-center">
            <div
              className="inline-flex items-center gap-2 text-sm text-gray-500 bg-white px-4 py-2 rounded-full shadow-lg 
              hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default
              border border-gray-100"
            >
              <Infinity className="h-4 w-4 text-primary" />
              <span>
                Des entreprises de renom nous font confiance depuis{" "}
                <strong className="text-primary">1959</strong>
              </span>
            </div>
          </div>
        </section>
        ...
        >
          <div className="relative container mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <span className="text-primary text-sm font-medium tracking-wider uppercase animate-pulse">
                Collection Prestige
              </span>
