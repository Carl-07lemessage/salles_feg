...
Le serveur SMTP à utiliser (Gmail dans ce cas)
...
Pour tester votre configuration SMTP, créez un fichier `test-email.mjs` à la racine du projet :
    ...
    transporter.sendMail(
      {
        ...
        html: "<h1>Test Email</h1><p>Configuration Nodemailer fonctionnelle ✅</p>",
      },
      (err, info) => {
        if (err) {
